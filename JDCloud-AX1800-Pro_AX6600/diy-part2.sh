...
sudo sed -i 's/192.168.1.1/172.30.3.200/g' package/base-files/files/bin/config_generate
sudo sed -i 's/255.255.255.0/255.255.255.0/g' ./package/base-files/files/bin/config_generate
